...
export const alt = "Platinum Price Today — Futures Price | Lode";
      ...
      >
        ...
        <div
          style={{
            ...
            height: "500px",
            borderRadius: "50%",
            background: "radial-gradient(circle, rgba(229,228,226,0.05) 0%, transparent 70%)",
          }}
        />
        ...
        <div
          style={{
            ...
            right: 0,
            height: "4px",
            background: "linear-gradient(to right, #9ca3af, #E5E4E2, transparent)",
          }}
        />
      </div>
    ),
