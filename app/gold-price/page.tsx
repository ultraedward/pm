      ...
      "mainEntity": [
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": `The current gold spot price is shown at the top of this page, refreshed once a day from ${PRICE_SOURCES.gold.provider}'s rate feed — true spot, not futures. The exact time it was last updated is shown alongside the price. Gold's underlying market price changes continuously during market hours (Sunday 6pm to Friday 5pm ET); on weekends and holidays it reflects the last traded value.`,
          },
        },
        {
          "@type": "Question",
...
export default async function GoldPricePage() {
  ...
  // intraday move past that snapshot (very common — gold trades continuously)
  // can leave the box stale relative to the live spot price shown at the top of
  // this page. Fold today's live spot into the high/low so the two numbers on
  // the page never contradict each other (high >= spot >= low, always).
      ...
      <main className="overflow-x-hidden" style={{ backgroundColor: "var(--bg)", color: "var(--text)" }}>
        ...
        <section className="px-4 sm:px-6 pb-8">
          <div className="mx-auto max-w-2xl">
            <MetalPriceChart metal="gold" livePrice={spot > 0 ? spot : undefined} />
          </div>
        </section>
          ...
          <div className="mx-auto max-w-2xl space-y-6">
            ...
            {weightRows.length > 0 && (
              <div className="border overflow-hidden" style={{ borderColor: "var(--border)" }}>
                ...
                >
                  <span className="h-1.5 w-1.5 rounded-full flex-shrink-0" style={{ background: "#D4AF37" }} />
                  <p className="label">Gold price by weight — today</p>
                </div>
            ...
            <div className="space-y-10 text-sm text-gray-400 leading-relaxed">
              ...
              <div className="space-y-3">
                ...
                <p>
                  ...
                  <Link href="/gold-ira" className="link-gold">
                    Gold IRA guide
                  </Link>
                  .
                </p>
