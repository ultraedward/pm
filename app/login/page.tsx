  ...
  return (
    <main className="min-h-screen bg-black flex items-center justify-center px-6">
      ...
      <div className="relative w-full max-w-sm space-y-8 text-center">
        ...
        {/* Sign-in card */}
        <div className="rounded-2xl border border-white/10 bg-gray-950 p-8 space-y-4">
          <button
            onClick={() => signIn("google", { callbackUrl: "/dashboard" })}
            className="flex w-full items-center justify-center gap-3 rounded-full border border-white/10 bg-white/5 px-6 py-3 text-sm font-medium text-white hover:bg-white/10 hover:border-white/20 transition-colors"
          >
            {/* Google icon */}
