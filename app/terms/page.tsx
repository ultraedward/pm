      ...
      <div className="mx-auto max-w-2xl space-y-12">
        ...
        <div className="space-y-8 text-sm text-gray-400 leading-relaxed">
          ...
          <section className="space-y-3">
            ...
            <p>Precious Metals provides intraday spot price tracking (updated approximately every 15 minutes), price alert notifications, and portfolio tracking for gold, silver, platinum, and palladium. Spot prices are sourced from third-party data providers and are provided for informational purposes only.</p>
          </section>
