    ...
    <div className="hidden sm:flex items-center gap-8">
      {isLoggedIn ? (
        ...
        <>
          ...
          <Link href="/platinum-price"  className={`hidden md:inline-flex ${linkClass("/platinum-price")}`}  style={activeStyle("/platinum-price")}  aria-current={isActive("/platinum-price")  ? "page" : undefined}>Platinum</Link>
          <Link href="/palladium-price" className={`hidden md:inline-flex ${linkClass("/palladium-price")}`} style={activeStyle("/palladium-price")} aria-current={isActive("/palladium-price") ? "page" : undefined}>Palladium</Link>
          <Link href="/compare"         className={linkClass("/compare")}         style={activeStyle("/compare")}         aria-current={isActive("/compare")         ? "page" : undefined}>Compare</Link>
